...
TEST_CASE("Color Grayscale Constructor", "[Color]") {
	Color color(0.5f);
	CHECK(color == Color(0.5f, 0.5f, 0.5f, 1.0f)); // All components should be equal
}

TEST_CASE("Color from uint32_t", "[Color]") {
...
TEST_CASE("Color::as_uint Tests", "[Color]") {
