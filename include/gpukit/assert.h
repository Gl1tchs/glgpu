...
#define GPUKIT_INTERNAL_ASSERT_NO_MSG(check)                                                       \
	GPUKIT_INTERNAL_ASSERT_IMPL(check, "Assertion '{}' failed at {}:{}",                           \
			GPUKIT_STRINGIFY_MACRO(check), __FILE__, __LINE__)
...
#define GPUKIT_ASSERT(...)                                                                         \
	GPUKIT_EXPAND_MACRO(GPUKIT_INTERNAL_ASSERT_GET_MACRO(__VA_ARGS__)(__VA_ARGS__))
